...
## iter 13 · phase3_001_iter_013 · cer=0.254500 (Δ+0.000000) · reject
...
## iter 14 · phase3_001_iter_014 · cer=0.266420 (Δ-0.011920) · reject
...
## iter 15 · phase3_001_iter_015 · cer=0.284501 (Δ-0.030000) · reject

### 관찰
corpus_cer=0.284501, total_inference_time_s=166.6

### 분석
not enough improvement: Δcer -0.030000 < 0.010000

### 다음 후보
직전 결과와 diagnosis를 보고 다음 단일 변경을 선택한다.

## iter 16 · phase3_001_iter_016 · cer=0.284501 (Δ-0.030000) · reject

### 관찰
corpus_cer=0.284501, total_inference_time_s=169.8
...
## iter 17 · phase3_001_iter_017 · cer=0.266420 (Δ-0.011920) · reject

### 관찰
corpus_cer=0.266420, total_inference_time_s=181.6
...
## iter 18 · phase3_001_iter_018 · cer=0.254500 (Δ+0.000000) · reject

### 관찰
corpus_cer=0.254500, total_inference_time_s=182.7
...
## iter 19 · phase3_001_iter_019 · cer=0.266420 (Δ-0.011920) · reject

### 관찰
corpus_cer=0.266420, total_inference_time_s=176.8
...
## iter 20 · phase3_001_iter_020 · cer=0.403830 (Δ-0.149330) · reject

### 관찰
corpus_cer=0.403830, total_inference_time_s=225.1

### 분석
not enough improvement: Δcer -0.149330 < 0.010000

### 다음 후보
직전 결과와 diagnosis를 보고 다음 단일 변경을 선택한다.

## iter 21 · phase3_001_iter_021 · cer=0.284501 (Δ-0.030000) · reject

### 관찰
corpus_cer=0.284501, total_inference_time_s=186.9
...
## iter 22 · phase3_001_iter_022 · cer=0.284501 (Δ-0.030000) · reject

### 관찰
corpus_cer=0.284501, total_inference_time_s=175.1
...
## iter 23 · phase3_001_iter_023 · cer=0.268154 (Δ-0.013654) · reject

### 관찰
corpus_cer=0.268154, total_inference_time_s=178.7

### 분석
not enough improvement: Δcer -0.013654 < 0.010000

### 다음 후보
직전 결과와 diagnosis를 보고 다음 단일 변경을 선택한다.

## iter 24 · phase3_001_iter_024 · cer=0.253551 (Δ+0.000950) · reject

### 관찰
corpus_cer=0.253551, total_inference_time_s=174.9

### 분석
not enough improvement: Δcer 0.000950 < 0.010000

### 다음 후보
직전 결과와 diagnosis를 보고 다음 단일 변경을 선택한다.

## iter 25 · phase3_001_iter_025 · cer=0.257968 (Δ-0.003468) · reject

### 관찰
corpus_cer=0.257968, total_inference_time_s=170.9

### 분석
not enough improvement: Δcer -0.003468 < 0.010000
