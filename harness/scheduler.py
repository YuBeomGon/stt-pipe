...
# **discovery-pressure 재조정 (2026-06-02)**: phase3_011 회귀 분석 — 새 하네스가
# discovery 30% / exploit 70% 로 돌아 mediocre 구조(~0.185)에 조기 수렴했고, run50
# (100% discovery)이 찾은 우월한 timestamp-seek 구조(0.157)를 못 찾았다. STT 의 이득은
# 구조 발견(exploration)에서 나오므로 explore floor 를 전 구간에서 크게 올리고
# combine/ablate 를 뒤로 민다. 추가로 DISCOVERY_FLOOR_FRAC 까지는 explore-only override.
_PHASES: tuple[tuple[float, dict[str, float]], ...] = (
    (0.40, {"explore": 0.75, "refine": 0.25, "combine": 0.00, "ablate": 0.00}),
    (0.75, {"explore": 0.50, "refine": 0.25, "combine": 0.13, "ablate": 0.12}),
